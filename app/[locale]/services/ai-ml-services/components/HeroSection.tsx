      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            Turn AI from Experimentation into <span className="text-[#fe7725]">Real Business Impact</span>
          </h1>
          
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            Organizations today investing in AI are still stuck in pilots. Models don't move to production, data isn't ready, and use cases fail to scale beyond experimentation.
          </p>

          <p className="text-xl text-white font-semibold mb-10">
            AI/ML services bridge that gap—turning data into intelligent systems that automate decisions, optimize operations, and unlock measurable business value.
          </p>
          ...
          <Link
            ...
            data-testid="start-transformation-btn"
          >
