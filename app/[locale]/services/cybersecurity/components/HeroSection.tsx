  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-12 sm:py-16 lg:py-20 overflow-hidden">
      <div className="absolute inset-0 opacity-20">
        <img
          src="/images/services/cybersecurity/hero-bg.jpg"
          alt="Cybersecurity"
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 leading-tight">
            Your Managed Security Services Provider <span className="text-[#fe7725]">Built For the Enterprise</span>
          </h1>
          
          <h2 className="text-xl sm:text-2xl lg:text-3xl font-semibold text-gray-200 mb-6">
            Achieving goals with a robust security toolbox.
          </h2>

          <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-6 sm:mb-8 leading-relaxed max-w-3xl mx-auto">
            Detect, respond, and eliminate threats before they impact your business. Tailored solutions designed for Enterprise & SaaS environments.
          </p>
