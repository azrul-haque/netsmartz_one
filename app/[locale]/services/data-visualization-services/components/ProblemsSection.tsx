...
import { FiLayers, FiTarget, FiClock, FiUsers, FiFileText } from 'react-icons/fi';

const ProblemsSection: React.FC = () => {
  const problems = [
    {
      icon: <FiLayers className="text-2xl" />,
      text: 'Dashboards overloaded with data but lacking clarity and focus'
    },
    {
      icon: <FiTarget className="text-2xl" />,
      text: 'Inconsistent metrics across teams leading to misaligned decisions'
    },
    {
      icon: <FiClock className="text-2xl" />,
      text: 'Delayed reporting that impacts business responsiveness'
    },
    {
      icon: <FiUsers className="text-2xl" />,
      text: 'Limited accessibility for non-technical stakeholders'
    },
    {
      icon: <FiFileText className="text-2xl" />,
      text: 'Static reports that fail to support real-time decision-making'
    }
  ];
