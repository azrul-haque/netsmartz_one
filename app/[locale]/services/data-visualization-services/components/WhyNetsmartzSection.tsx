...
import { FiAward, FiUsers, FiBarChart2, FiDatabase, FiGlobe } from 'react-icons/fi';
...
const WhyNetsmartzSection: React.FC = () => {
  const reasons = [
    ...
    { icon: <FiBarChart2 className="text-2xl" />, text: 'Strong expertise in Power BI and modern BI tools' },
    { icon: <FiDatabase className="text-2xl" />, text: 'Deep understanding of data modeling and reporting' },
