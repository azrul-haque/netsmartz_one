      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            Build a Scalable Data Foundation for <span className="text-[#fe7725]">Real-Time Insights</span>
          </h1>
          
          <p className="text-xl text-gray-300 mb-10 leading-relaxed">
            Most businesses struggle with fragmented data, complex pipelines, and delayed reporting—leading to inefficiencies, rising costs, and slower decision-making. We help you build modern data lake and warehouse architectures where data is structured, accessible, and ready to drive real-time insights.
          </p>
          ...
          <Link
            ...
            data-testid="build-foundation-btn"
          >
