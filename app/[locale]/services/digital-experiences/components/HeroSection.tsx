  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-10 overflow-hidden">
      <div className="absolute inset-0 opacity-20">
        <img
          src="/images/services/digital-experiences/hero-digital-experience.jpg"
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Crafting Awesome <span className="text-[#fe7725]">Digital Experiences</span>
          </h1>
          
          <p className="text-lg sm:text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
            With a pool of cutting-edge Adobe Experience Cloud products, we create personalized experiences to deliver content, digital assets, and commerce.
          </p>
