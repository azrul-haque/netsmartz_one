  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-12 sm:py-16 lg:py-20 overflow-hidden">
      <div className="absolute inset-0 opacity-20">
        <img
          src="/images/services/managed-cloud-services/hero-cloud.jpg"
      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 leading-tight">
            Unlock the Full Potential of Your Cloud with <span className="text-[#fe7725]">Expert Strategy & Optimization</span> by Netsmartz
          </h1>
          
          <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-6 sm:mb-8 leading-relaxed max-w-3xl mx-auto">
            Maximize performance, reduce costs, and ensure scalability with tailored cloud solutions designed for your business success.
          </p>
