...
import { FiAward, FiCheckCircle, FiTrendingUp, FiSearch, FiUsers, FiZap } from 'react-icons/fi';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
          {competencies.slice(0, 3).map((competency, index) => {
            ...
            return (
              ...
              >
                <div className="w-16 h-16 mb-4 bg-[#fe7725] rounded-lg flex items-center justify-center">
