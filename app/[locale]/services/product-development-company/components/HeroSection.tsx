  ...
  return (
    <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-10 overflow-hidden">
      <div className="absolute inset-0 opacity-20">
        <img
          src="/images/services/product-development-company/hero-team.jpg"
          alt="Product Development Teams"
      ...
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight">
            Hire Expert <span className="text-[#fe7725]">Product Development Teams</span> Today!
          </h1>
